                ...
                <div className="flex flex-col lg:flex-row-reverse gap-10 lg:gap-16 items-center">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-right">
                        ...
                        <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-l from-purple-400 to-indigo-500">
                                Data Driven
                            </span>
                        </h2>
                        <p className="text-gray-400 text-sm lg:text-lg mb-8 mx-auto lg:ml-auto max-w-xl">
                        ...
                        <div className="grid grid-cols-2 gap-3 lg:gap-4">
                            {serviciosMarketing.map((item, i) => (
                                <div
                                    key={i}
                                    className="group p-4 lg:p-5 rounded-2xl bg-[#0B0F19]/60 border border-white/5 backdrop-blur-xl text-left hover:border-purple-500/30 transition-colors"
                                >
                                    <div className="flex items-center justify-between mb-2">
                                        <item.icon className="text-purple-400" size={18} />
                                        <ArrowRight className="text-white/20 lg:group-hover:text-purple-400 transition-all -rotate-45" size={14} />
                                    </div>
                                    <h3 className="font-bold text-white text-[12px] lg:text-sm mb-1">{item.titulo}</h3>
                                    <p className="hidden md:block text-[10px] text-gray-500 leading-tight">{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="relative bg-[#0B0F19]/80 backdrop-blur-3xl border border-purple-500/20 rounded-[24px] lg:rounded-[32px] p-6 lg:p-8 shadow-2xl overflow-hidden">
                            <div className="flex justify-between items-start mb-6 lg:mb-8 relative z-10">
                                <div>
                                    <p className="text-gray-500 text-[10px] font-mono uppercase tracking-widest mb-1">Performance Index</p>
                                    <h3 className="text-2xl lg:text-4xl font-bold text-white flex items-center gap-2">
                                        +145%
                            ...
                            <div className="flex justify-between mt-6 pt-4 border-t border-white/5 text-[10px] text-gray-500 font-mono tracking-tighter">
